...
public class Step1 {
    ...
    public static final Target TXT_SELECT_MONTH = Target.the("Required month").located(By.xpath("//option[text()='April']"));
    public static final Target TXT_DAY = Target.the("Day field").located(By.id("birthDay"));
    public static final Target TXT_SELECT_DAY = Target.the("Required day").located(By.xpath("//option[text()='10']"));
    public static final Target TXT_YEAR = Target.the("Year field").located(By.id("birthYear"));
    public static final Target TXT_SELECT_YEAR = Target.the("Required year").located(By.xpath("//option[text()='1991']"));
